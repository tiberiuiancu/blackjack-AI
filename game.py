...
class Game:
    ...
    def step(self, move=None):
        ...
        # split in play
        if self.split_queue[self.to_play]:
            current_cards = self.split_queue[self.to_play][self.split_index]
            ...
            if self.split_index >= len(self.split_queue):
...
if __name__ == '__main__':
    ...
    game.game_state[0][0] = game.game_state[0][1]
