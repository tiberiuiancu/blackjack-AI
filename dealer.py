...
if __name__ == '__main__':
    outcomes = [0, 'split', 'tbd', 'tbd']
    game_state = [[10, 10, 10], [7, 7], [1, 1, 1, 10], [6, 6, 6], [0, 0]]
    bets = [1, [1, 1], 1, 1]
    split_queue = [[], [[7, 5, 6], [7, 10]], [], []]

    print(compute_expected(game_state[-1], compute_unfinished(game_state, outcomes, split_queue, bets)))
